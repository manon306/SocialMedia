...
namespace SocialMedia.DAL.Migrations
{
    ...
    [Migration("20250917150153_ADDGoogleMapAtt")]
    partial class ADDGoogleMapAtt
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SocialMedia.DAL.Entity.Follow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SocialMedia.DAL.Entity.Comment", b =>
                {
                    b.HasOne("SocialMedia.DAL.Entity.User", "CreatedBy")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("SocialMedia.DAL.Entity.Follow", b =>
                {
                    b.HasOne("SocialMedia.DAL.Entity.User", "Follower")
                        .WithMany()
                        .HasForeignKey("FollowerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("SocialMedia.DAL.Entity.User", "Following")
                        .WithMany()
